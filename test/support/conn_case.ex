defmodule CriticosWeb.ConnCase do
  @moduledoc """
  ...
  by setting `use CriticosWeb.ConnCase, async: true`, although
  ...
  using do
    quote do
      ...
      import CriticosWeb.ConnCase
    end
  end

  setup tags do
    Criticos.DataCase.setup_sandbox(tags)
  ...
  def log_in_user(conn, user) do
    token = Criticos.Accounts.generate_user_session_token(user)
  ...
  def user(_), do: %{user: user_fixture()}
end
